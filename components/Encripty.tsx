        ...
        <div className="flex flex-col items-center p-4 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md w-full mb-6">
                ...
                <div className="text-sm text-gray-600 mb-6">
                    <p>
                        Na etapa de <strong>empacotamento e envio</strong>, todos os elementos processados são
                        combinados em um único pacote seguro para envio. O pacote contém:
                    </p>
                    <ul className="list-disc ml-6">
                        <li><strong className="text-blue-400">Arquivo cifrado com chave simétrica</strong>: Garante a
                            segurança do conteúdo.
                        </li>
                        <li><strong className="text-yellow-400">Assinatura digital do arquivo original</strong>:
                            Confirma a autenticidade do arquivo.
                        </li>
                        <li><strong className="text-purple-400">Chave simétrica cifrada com RSA</strong>: Protege o
                            acesso à chave usada para encriptar o arquivo.
                        </li>
                    </ul>
                    <p className="mt-4">
                    ...
                    <ul className="list-disc ml-6">
                        <li><strong className="text-green-400">Confidencialidade</strong>: O conteúdo do arquivo e a
                            chave são protegidos contra interceptação.
                        </li>
                        <li><strong className="text-green-400">Integridade</strong>: O arquivo não será alterado durante
                            o transporte.
                        </li>
                        <li><strong className="text-green-400">Autenticidade</strong>: O remetente é validado através da
                            assinatura digital.
                        </li>
                    </ul>
                </div>
