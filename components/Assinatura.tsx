...
import {FaFile, FaKey, FaLock, FaSignature} from 'react-icons/fa';
    ...
    return (
        <div
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                <div>
                    <FaFile className="text-blue-500 text-4xl mx-auto"/>
                    <h3 className="mt-4 text-lg font-semibold text-gray-700">Arquivo Original</h3>
                    <p className="mt-2 text-gray-600">O arquivo é preparado para processamento</p>
                </div>
                <div>
                    <FaSignature className="text-blue-500 text-4xl mx-auto"/>
                    <h3 className="mt-4 text-lg font-semibold text-gray-700">Assinatura Digital</h3>
                    <p className="mt-2 text-gray-600">Garante a autenticidade do arquivo</p>
                </div>
                <div>
                    <FaLock className="text-blue-500 text-4xl mx-auto"/>
                    <h3 className="mt-4 text-lg font-semibold text-gray-700">Cifragem</h3>
                    <p className="mt-2 text-gray-600">Protege o conteúdo do arquivo</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-4xl mx-auto">
                <div
                    className="p-6 bg-blue-200 rounded-lg shadow-xl flex flex-col items-center space-y-4 hover:bg-blue-300 transition duration-300">
                ...
                <div
                    className="p-6 bg-yellow-200 rounded-lg shadow-xl flex flex-col items-center space-y-4 hover:bg-yellow-300 transition duration-300">
